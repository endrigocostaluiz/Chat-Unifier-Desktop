...
- **Contador de Viewers para Stream:** Novo overlay horizontal customizável com suporte a layout **Pilhado** e customização total via CSS.
- **Scraping Local Seguro:** Captura mensagens localmente, garantindo máxima privacidade e agilidade.

### 🚀 Como Começar
1. Baixe a versão estável v1.2.4 em [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
...
- **Stream Viewer Counter:** New customizable horizontal overlay with **Stacked** layout support and full CSS customization.
- **Secure Local Scraping:** Captures messages locally, ensuring privacy and speed.

### 🚀 How to Get Started
1. Download the stable v1.2.4 from [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
