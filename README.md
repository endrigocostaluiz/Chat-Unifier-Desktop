...
### 🚀 Como Começar
1. Baixe a versão estável v1.2.7 em [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
...
### 🚀 How to Get Started
1. Download the stable v1.2.7 from [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
