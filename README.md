...
- **Contador de Viewers para Stream:** Novo overlay horizontal customizável com suporte a layouts **Pilhado**, **Badges + Total** e customização total via CSS.
- **Scraping Local Seguro:** Captura mensagens localmente, garantindo máxima privacidade e agilidade.

### 🚀 Como Começar
1. Baixe a versão estável v1.2.5 em [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
...
<img width="1183" height="785" alt="image" src="https://github.com/user-attachments/assets/57f3c3ab-4326-4a13-96a8-5f7189556afc" />

<img width="1183" height="785" alt="contatodrpt" src="https://github.com/user-attachments/assets/8d648c68-55c3-4626-9999-9b3a0734873f" />
...
- **Stream Viewer Counter:** New customizable horizontal overlay with **Stacked**, **Badges + Total** layout support and full CSS customization.
- **Secure Local Scraping:** Captures messages locally, ensuring privacy and speed.

### 🚀 How to Get Started
1. Download the stable v1.2.5 from [Releases](https://github.com/endrigocostaluiz/Chat-Unifier-Desktop/releases).
...
<img width="1183" height="785" alt="en" src="https://github.com/user-attachments/assets/717393fc-aa7b-4c85-a018-c912af4d7922" />

<img width="1183" height="785" alt="contatoen" src="https://github.com/user-attachments/assets/bac0a333-3a54-43e2-b4c9-596459dc5cc1" />
